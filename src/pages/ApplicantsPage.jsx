...
export default function ApplicantsPage() {
  ...
  const fetchAllApplicants = useCallback(async (pageNum, append = false) => {
    if (loading) return;
  ...
  const searchApplicantsWithFilters = useCallback(async (pageNum, append = false) => {
    if (!hasActiveFilters()) {
  ...
  }, [loading, fetchAllApplicants, hasActiveFilters, searchQuery, selectedCountry, selectedEducation]);
  ...
  }, [hasMore, loading, initialLoading, page, isFilterMode, fetchAllApplicants, searchApplicantsWithFilters]);
