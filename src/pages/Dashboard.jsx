        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-blue-600">DEVision</h1>
              <span className="ml-2 text-sm text-gray-500">Job Manager</span>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-gray-700">{user?.companyName || user?.email}</span>
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Role: <span className="font-medium">{user?.role || 'COMPANY'}</span> |
